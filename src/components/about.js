    ...
    return (
        <div className="container-about p-3 mt-5">
            ...
            <div className="d-flex flex-column align-items-center flex-lg-row text-lg-center mb-5 mx-5">
                <Img className="img-robot first" style={{ filter: 'drop-shadow(0 0 5px black)' }} fluid={data.imgRobot.childImageSharp.fluid} />
            ...
            <div className="d-flex flex-column align-items-center flex-lg-row-reverse text-lg-center mb-5 mx-5">
                <Img className="img-robot" style={{ filter: 'drop-shadow(0 0 1px black)' }} fluid={data.imgRobotShare.childImageSharp.fluid} />
            ...
            <div className="d-flex flex-column align-items-center flex-lg-row text-lg-center mb-5 mx-5">
                <Img className="img-robot" style={{ filter: 'drop-shadow(0 0 1px black)' }} fluid={data.imgRobotCommunication.childImageSharp.fluid} />
            ...
            <div className="d-flex flex-column align-items-center flex-lg-row-reverse text-lg-center mb-5 mx-5">
                <Img className="img-robot" style={{ filter: 'drop-shadow(0 0 2px black)' }} fluid={data.imgRobotWorker.childImageSharp.fluid} />
            ...
            <div className="d-flex flex-column align-items-center mb-5 container-end">
                <span>Bref</span>
                <Img className="robot-end" fluid={data.imgRobotDeveloper.childImageSharp.fluid} />
